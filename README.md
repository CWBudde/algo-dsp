...
| `dsp/filter/mixedphase` | Fixed-length mixed-phase FIR design: DAGA 2012 alternating factorisation, direct phase-interpolation baseline, weighted complex least squares with Lawson minimax refinement, direct low-group-delay optimisation, cepstral and discrete-Hilbert minimum phase, and comparison metrics          |
| `dsp/filter/graphiceq`  | Low-latency octave graphic EQ: the lowest bands become a cascade of shelving biquads and the rest one linear-phase FIR, halving latency per offloaded band                                                                                                                                      |
