...
| `dsp/filter/mixedphase` | Fixed-length mixed-phase FIR design: DAGA 2012 alternating factorisation, direct phase-interpolation baseline, real-cepstrum minimum phase, and comparison metrics                                                                                                                              |
