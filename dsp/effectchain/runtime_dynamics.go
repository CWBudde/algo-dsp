...
func (r *compressorRuntime) Configure(ctx Context, p Params) error {
	...
	return r.fx.SetMakeupGain(core.Clamp(p.GetNum("makeupGainDB", 0), 0, 24))
}
...
func (r *limiterRuntime) Configure(ctx Context, p Params) error {
	...
	return r.fx.SetRelease(core.Clamp(p.GetNum("releaseMs", 100), 1, 5000))
}
...
func (r *lookaheadLimiterRuntime) Configure(ctx Context, p Params) error {
	...
	return r.fx.SetLookahead(core.Clamp(p.GetNum("lookaheadMs", 3), 0, 200))
}
...
func (r *gateRuntime) Configure(ctx Context, p Params) error {
	...
	return r.fx.SetRange(core.Clamp(p.GetNum("rangeDB", -80), -120, 0))
}
...
func (r *expanderRuntime) Configure(ctx Context, p Params) error {
	...
	return r.fx.SetRMSWindow(core.Clamp(p.GetNum("rmsWindowMs", 30), 1, 1000))
}
...
func (r *transientShaperRuntime) Configure(ctx Context, p Params) error {
	...
	return r.fx.SetRelease(core.Clamp(p.GetNum("releaseMs", 120), 1, 2000))
}
